...
const StudentLogin = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    setLoading(true);
    setError('');
    console.log('Student login attempt:', formData.email);
    try {
      ...
      console.log('Student login success, decoded role:', role, 'navigating to dashboard');
      navigate('/student-dashboard', { replace: true });
    } catch (err) {
      console.error('Student auth error:', err.code, err.message);
      ...
      <div className="login-container">
        <div className="login-header">
          ...
          <div className="login-brand">
            ...
            <div><h1>Student Portal</h1><p>Bright Future Academy</p></div>
          </div>
        </div>
