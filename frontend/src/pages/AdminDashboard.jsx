...
const AdminDashboard = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      try {
        ...
        const response = await fetch('https://school-management-system-website-backend.onrender.com/api/admin/dashboard', {
  ...
  const handleCreateUser = async (e) => {
    ...
    const token = localStorage.getItem('token');
    try {
      const response = await fetch('https://school-management-system-website-backend.onrender.com/api/admin/create-user', {
        method: 'POST',
        headers: { 
